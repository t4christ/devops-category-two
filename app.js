...
const contractArtifact = require('./contract/build/contracts/TestToken.json');
...
// ----------------------------- Get Test Token Balance Endpoint -----------------------------------
...
const contractAddress = contractArtifact.networks[`${process.env.networkId}`].address;
